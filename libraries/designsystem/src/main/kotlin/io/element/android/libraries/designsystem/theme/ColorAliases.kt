...
// AfriChat: sent messages use AfriChat green tint
val SemanticColors.messageFromMeBackground
    get() = if (isLight) Color(0xFFD4EDDA) else Color(0xFF1A4D2E)

// AfriChat: received messages use neutral background
val SemanticColors.messageFromOtherBackground
    get() = if (isLight) Color(0xFFF2F2F2) else Color(0xFF2C2C2C)
