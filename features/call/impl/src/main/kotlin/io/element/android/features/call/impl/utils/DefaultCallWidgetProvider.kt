...
/** Bundled Element Call assets URL (fallback when no custom URL is configured). */
private const val EMBEDDED_CALL_WIDGET_BASE_URL = "https://appassets.androidplatform.net/element-call/index.html"

/** AfriChat default call backend — uses our LiveKit server. */
private const val AFRICHAT_DEFAULT_CALL_URL = EMBEDDED_CALL_WIDGET_BASE_URL
...
class DefaultCallWidgetProvider(
    ...
    override suspend fun getWidget(
        ...
        val baseUrl = customBaseUrl ?: AFRICHAT_DEFAULT_CALL_URL
